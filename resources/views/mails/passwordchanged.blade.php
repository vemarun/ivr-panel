                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                        ...
                                                                        <center><p style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;"><b>This is an alert mail.<br><h3>Your Password was changed recently.</h3></b></p>

                                                                        <p>
                                                                        	If this action was not taken by you, you should immediately contact our support.
                                                                        </p></center>
                                          ...
                                          <tr>
                                             <td align="center" width="100%">
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                   <tbody>
                                                      <tr>
                                                         <td align="center" width="100%">Don't reply to this email. This email was automatically generated.</td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                             </td>
