...
<head>
    ...
    @include('clientivr.layout.header1')
    <!-- START SIDEBAR-->
    @include('clientivr.layout.side-header1')
    <!-- END SIDEBAR-->
                ...
                <div class="col-md-8">
                    <form class="form-horizontal" method="post">
                        <div class="form-group">
                            <label class="control-label col-sm-4" for="userid">Registered User Name / Email-ID:</label>
                            <div class="col-sm-8">
					  ...
					  <input type="radio" name="via">By Email
					</label>
                                <label class="radio-inline">
					  <input type="radio" name="via">By Number
					</label>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            <div class="col-md-offset-4 col-md-8">
                                ...
                                <div style="padding-top: 15px;">
                                    <a href="/clientlogin" style="color:#dd6a39;">Click here to login</a>
                                </div>
                            </div>
