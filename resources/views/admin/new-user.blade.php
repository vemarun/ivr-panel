                                ...
                                <div class="col-md-3">
									...
									<div id="selected_form_code">
                                        <label>Client Type:<sup>*</sup></label>
										 <select class="form-control clientselect" style="height: 35px;" name="clientselect" onchange="getFormAccordingly(this.value);" required>
											<option disabled selected="selected">Selected Client Type</option>
                                    ...
                                    <div class="col-md-3">
                                            <div class="form-group mb-4">
                                                <label>Plan:<sup>*</sup></label>
                                                 <select class="form-control" name="select_plan" style="height: 35px;" required>
								...
								{{-- <div class="col-md-3">
                                    ...
                                    <div class="form-group mb-4">
                                        <label>Industry Type:</label>
										 <select class="form-control" name="industry" style="height: 35px;" required>
                                    ...
                                    <div class="form-group mb-4">
                                        <label>Product Type:</label>
										 <select class="form-control" name="product" style="height: 35px;" required>
                                    ...
                                    <div class="col-md-3">
                                            <div class="form-group mb-4">
                                                <label>Price Slab:</label>
                                                 <select class="form-control" name="price" style="height: 35px;" required>
                                                    <option> &lt;5Lac </option>
									...
									<div class="col-md-3">
                                            <div class="form-group mb-4">
                                                <label>City:</label>
                                                 <select class="form-control" name="city" style="height: 35px;" required>
