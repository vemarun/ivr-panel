                        ...
                        <div class="ibox-body">
							...
							<div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <label>ID/Username/Source Number</label>
            ...
            success:function(response){
                ...
                $.each(response,function(index,element){
                    ...
                    <tr>
                        ...
                        <td><a href='/user-templates/${element.id}' style='color:#dd6a39;'><i class='fa fa-edit' title='Edit Template'></i></a>&nbsp;&nbsp;</td>

                        <td><a href='/admin/edit-user-pid?user_id=${element.id}' style='color:#dd6a39;'><i class='fa fa-edit' title='Edit Profile'></i></a>&nbsp;&nbsp;
                            <a href='/admin/did-list?user_id=${element.id}' style='color:#dd6a39;'>
                                <i class='fa fa-file-text-o' title='DID List' ></i></a>&nbsp;&nbsp;
                            <a href='/impersonate/take/${element.id}' style='color:#dd6a39;' data-id='${element.id}' id='login'>
                                <i class='fa fa-sign-in' title='Login Here' ></i></a>&nbsp;&nbsp;
                        </td>
                    </tr>`);
...
<div class='modal-header' style="background:#140F6D;color:white !important"> <h4 class='modal-title'>Add IVR Credit to User Account</h4><button aria-label='Close' data-dismiss='modal' class='close' type='button'>
...
<div class='modal-header' style="background:#140F6D;color:white !important"> <h4 class='modal-title'>Enhance Validity to User Account</h4><button aria-label='Close' data-dismiss='modal' class='close' type='button'>
