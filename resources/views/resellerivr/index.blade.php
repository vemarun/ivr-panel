...
<head>
	...
	<style>
        .recolor { filter: hue-rotate(220deg); }
        .recolor:hover {
    ...
    @include('resellerivr.layouts.header')
     ...
     @include('resellerivr.layouts.side-header')
		<!-- END SIDEBAR-->
		<center><img src="../images/loader.gif" id="loader" style="margin-top:20%">  </center>
        <div class="wrapper content-wrapper">
            ...
            <div class="page-heading">
                ...
                <!--reseller client data representation-->
                
              <div class="col-md-12  col-xs-12 col-sm-12 lul">
			<div class="row">
			...
			<div class="row">
					<div class="col-md-6">
							<table class="table live_call_table">
								...
								<tbody class='live_call_table_body' style='display: block; border: 1px solid green; height: 360px; overflow-y: scroll'>
...
$("#loader").hide();
		$(".lul").show();
                 ...
                 <!--reseller client data representation ends-->
