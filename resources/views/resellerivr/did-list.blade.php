...
<head>
    ...
    <title>Admin | Source Number List</title>
    <style>
  .modal-header, .close {
      color:white;
      font-size: 30px;
      ...
      background-color: #f9f9f9;
        ...
        <div class="wrapper content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Source Number List For <?=$_GET['user_id']; ?></h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="/index"><i class="la la-home font-20"></i></a>
                    </li>
                    <li class="breadcrumb-item">User List</li>
                    <li class="breadcrumb-item">Source Number List</li>
                </ol>
            </div><br>
...
<div id="source_modal">
        ...
        <div class='modal fade' id='sourceModal' role='dialog'>
                ...
                <h4 style='color:#f37335;' class='modal-title'>Forward Source Number To Application</h4> 
