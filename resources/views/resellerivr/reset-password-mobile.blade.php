    ...
    <title>Resellers IVR | Reset Password</title>
     ...
     @include('layouts.side-header1')
        ...
        <div class="wrapper content-wrapper">
			...
			<div class="col-md-8">
				<form class="form-horizontal" name="reset_form_mobile" method="post">
				...
				<div class="form-group">
				  <label class="control-label col-sm-4" for="acode"> Authentication Code:</label>
				  <div class="col-sm-5">
					<input type="text" class="form-control" id="acode" placeholder="Enter Authentication Code" name="acode" required>
				  </div>
				</div>
